						...
						>
							...
							>
								<Button
									...
									className={cn(
										"Canvas-chat-panel-collapse-button",
										"h-8 w-8 p-0"
									)}
								>
							...
							<div
								className={cn("Canvas-chat-content", "flex-1 overflow-y-auto")}
							>
								<Thread />
							</div>
						</div>
						...
						{chatCollapsed && (
							...
							>
								<Button
									...
									className={cn(
										"Canvas-content-panel-expand-button",
										"h-8 w-8 p-0"
									)}
								>
