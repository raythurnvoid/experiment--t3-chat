		...
		>
			<div className={cn("QuickStart-container", "max-w-2xl mx-auto text-center p-8")}>
				...
				<div className={cn("QuickStart-content", "space-y-6")}>
					<div className={cn("QuickStart-options", "grid md:grid-cols-2 gap-4")}>
						{/* Text option */}
						<div
							className={cn(
								"QuickStart-option",
						...
						>
							<Code
								className={cn("QuickStart-option-icon", "h-12 w-12 text-green-600 dark:text-green-400 mx-auto mb-4")}
							/>
							<h3
								className={cn("QuickStart-option-title", "text-xl font-semibold mb-2 text-gray-900 dark:text-gray-100")}
							>
