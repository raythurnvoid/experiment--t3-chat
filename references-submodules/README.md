...
| [chatto](chatto/) | Slack-like team chat contracts: channels, messages, one-level threads, reactions, attachments; design reference for the Chitchat plugin. AGPL — read-only, never copy code | [proto contracts](chatto/proto/chatto/api/v1/), [docs](chatto/docs/) |
...
| [liveblocks](liveblocks/) | Yjs provider, awareness, and Tiptap collaboration/comments/AI extensions; the app's `files-yjs-*` and `file-editor-rich-text-*` modules were adapted from here | [yjs package](liveblocks/packages/liveblocks-yjs/src/), [react-tiptap package](liveblocks/packages/liveblocks-react-tiptap/src/), [docs](liveblocks/docs/pages/) |
...
| [realtimekit-ui](realtimekit-ui/) | Cloudflare RealtimeKit prebuilt UI components source; check styling and customization behavior for the planned Meetings room UI | [README](realtimekit-ui/README.md), [AGENTS](realtimekit-ui/AGENTS.md), [packages](realtimekit-ui/packages/) |
| [realtimekit-web-examples](realtimekit-web-examples/) | Cloudflare RealtimeKit meeting app examples and recording SDK samples for the planned Meetings feature | [README](realtimekit-web-examples/README.md), [AGENTS](realtimekit-web-examples/AGENTS.md), [React examples](realtimekit-web-examples/react-examples/), [recording samples](realtimekit-web-examples/recording-sdk-app-examples/) |
...
| [zero](zero/) | Raw Gmail/Microsoft mail-provider drivers, OAuth mail connect flow, and email sync patterns for the emails integration | [README](zero/README.md), [driver interface](zero/apps/server/src/lib/driver/types.ts), [Gmail driver](zero/apps/server/src/lib/driver/google.ts) |
