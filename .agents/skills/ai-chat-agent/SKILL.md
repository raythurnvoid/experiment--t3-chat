...
- While a response runs, the composer has one action button. Empty text shows Stop. Non-empty text shows Queue with the normal send icon. The accessible name and tooltip change with the action.
