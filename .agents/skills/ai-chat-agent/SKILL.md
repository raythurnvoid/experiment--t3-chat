...
- Pasting or dropping an image shows a removable badge; non-image files show a toast and attach nothing. Removing the badge disables an image-only send again.
