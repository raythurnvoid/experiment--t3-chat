...
- Current SDK pages send a query-free ready message immediately and every 500ms until init or page unload. The host alone owns the 15s startup deadline; Retry re-keys the iframe with a fresh nonce and session.
