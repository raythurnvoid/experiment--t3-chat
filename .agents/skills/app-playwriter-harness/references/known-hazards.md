...
- **Tooltips / hovercards** — hovercards need a real pointer position change (the Ariakit entries under Interaction Discipline). Tooltips are native (`native-popovers`); see the `MyTooltip` entries there.
