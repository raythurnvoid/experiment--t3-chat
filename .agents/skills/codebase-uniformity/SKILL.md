...
- **JSDoc paragraphs:** JSDoc renders as Markdown. Separate distinct paragraphs with an empty ` *` line. A line break alone joins the text in the rendered docs. Keep wrapped lines of the same paragraph together; do not add a blank line after every sentence.
