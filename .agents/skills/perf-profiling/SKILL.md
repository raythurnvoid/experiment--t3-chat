...
- Some extension connections reject `Profiler.enable` with "method not found". Check support before the timed action. Use in-page and network timings when it is unavailable; do not claim CPU attribution or reset a shared relay just for this error.
