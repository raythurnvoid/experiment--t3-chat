...
export const FileEditorSidebar = memo(function FileEditorSidebar(props: FileEditorSidebar_Props) {
	...
	const availableTabIds: AppElementId[] = isPlainTextFile
		? [FILE_EDITOR_SIDEBAR_TAB_ID_DETAILS, FILE_EDITOR_SIDEBAR_TAB_ID_AGENT, FILE_EDITOR_SIDEBAR_TAB_ID_PENDING]
		: [FILE_EDITOR_SIDEBAR_TAB_ID_COMMENTS, FILE_EDITOR_SIDEBAR_TAB_ID_AGENT, FILE_EDITOR_SIDEBAR_TAB_ID_PENDING];
