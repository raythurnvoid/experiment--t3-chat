...
type FileEditorRichTextToolsTextStyleToggle_ClassNames = "FileEditorRichTextToolsTextStyleToggle-active";
...
const FileEditorRichTextToolsTextStyleToggle = memo(function FileEditorRichTextToolsTextStyleToggle(
	...
	return (
		<MyIconButton
			...
			className={cn(
				isActive &&
					("FileEditorRichTextToolsTextStyleToggle-active" satisfies FileEditorRichTextToolsTextStyleToggle_ClassNames),
			)}
		>
			<MyIconButtonIcon>
				<Icon />
...
// #region root
export type FileEditorRichTextToolsTextStyles_ClassNames = "FileEditorRichTextToolsTextStyles";
...
export const FileEditorRichTextToolsTextStyles = memo(function FileEditorRichTextToolsTextStyles(
	props: FileEditorRichTextToolsTextStyles_Props,
) {
