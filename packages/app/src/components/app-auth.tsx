 ...
 *
 * Keep `isLoaded` / `isAuthenticated` consistent with
 * packages/app/src/routes/__root.tsx: once `isLoaded` is true,
 * the root route expects anonymous or signed-in identity
 * together with a Convex-authenticated client; any other
 * post-bootstrap outcome throws and is handled by the root route error boundary.
 */
