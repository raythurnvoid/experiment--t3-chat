...
import { server_convex_headers_preflight_cors } from "./lib/server_utils.ts";
import {
	ai_docs_temp_contextual_prompt,
	ai_docs_temp_liveblocks_auth,
	ai_docs_temp_liveblocks_webhook,
} from "./ai_docs_temp";
...
http.route({
	path: "/api/ai-docs-temp/liveblocks-webhook",
	method: "POST",
	handler: ai_docs_temp_liveblocks_webhook,
});
