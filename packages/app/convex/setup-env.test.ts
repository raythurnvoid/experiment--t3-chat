...
if (!process.env.COUNCIL_SERVICE_EXCHANGE_SECRET) {
	process.env.COUNCIL_SERVICE_EXCHANGE_SECRET = "COUNCIL_SERVICE_EXCHANGE_SECRET_TEST";
}

if (!process.env.COUNCIL_PLUGIN_NAME) {
	process.env.COUNCIL_PLUGIN_NAME = "council";
}
