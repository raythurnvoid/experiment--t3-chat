...
export declare const components: {
  ...
  files_content_materialization_workpool: {
    config: {
      update: FunctionReference<
        "mutation",
        "internal",
  ...
  files_upload_conversion_workpool: {
    config: {
      update: FunctionReference<
        "mutation",
        "internal",
