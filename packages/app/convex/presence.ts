...
export const heartbeat = mutation({
	...
	handler: async (ctx, args) => {
		...
		if (result.isNewSession) {
			await presence.setSessionData(ctx, result.roomToken, args.sessionId, {
...
export const setSessionData = mutation({
	args: { roomToken: v.string(), sessionId: v.string(), data: v.any() },
	returns: v.null(),
	handler: async (ctx, args) => {
		return await presence.setSessionData(ctx, args.roomToken, args.sessionId, args.data);
	},
});
