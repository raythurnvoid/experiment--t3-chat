...
const app_convex_schema = defineSchema({
	...
	threads: defineTable({
		...
		.index("by_workspace_project_archived", ["workspace_id", "project_id", "archived"])
		.index("by_workspace_project_last_message_at", ["workspace_id", "project_id", "last_message_at"]),

	/**
	 * Each doc should be compatible with {@link ai_chat_AiSdkUiMessage}.
	 */
	messages: defineTable({
		...
		/**
		 * AI SDK 5 {@link ai_chat_AiSdkUiMessage} object without `id` property as the id is generated by convex.
		 **/
		content: v.object({
